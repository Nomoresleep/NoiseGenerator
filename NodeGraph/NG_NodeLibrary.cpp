...
void NodeLibrary::UnregisterNodeTypes()
{
    ...
    NG_UnregisterNodeType("Math/V2/Add");
    NG_UnregisterNodeType("Math/V2/Sub");
    NG_UnregisterNodeType("Math/V2/Mult");
    NG_UnregisterNodeType("Math/V2/Div");
    NG_UnregisterNodeType("Math/float/Add");
    NG_UnregisterNodeType("Math/float/Sub");
    NG_UnregisterNodeType("Math/float/Mult");
    NG_UnregisterNodeType("Math/float/Div");
