...
#define IM_VEC2_CLASS_EXTRA                                                 \
        ...
        operator MC_Vector2f() const { return MC_Vector2f(x,y); }

#define IM_VEC4_CLASS_EXTRA                                                 \
        ImVec4(const MC_Vector4f& f) { x = f.x; y = f.y; z = f.z; w = f.w; }     \
        operator MC_Vector4f() const { return MC_Vector4f(x,y,z,w); }
