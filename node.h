...
template <>
void locRenderDrag<u32>(Property<u32>* aProperty)
{
...
template<>
PortType GetPortType<f32>() { return PortType::FloatPort; }

template<>
PortType GetPortType<i32>() { return PortType::IntPort; }

template<>
PortType GetPortType<u32>() { return PortType::UIntPort; }
